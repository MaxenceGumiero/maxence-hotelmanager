...
$router->get('/rooms/(\d+)/removeclient/', 'PagesController@removeClient');        // Traite le formulaire d'édition d'une room puis redirige
...
$router->get('/clients/(\d+)', 'ClientsController@show');                           // Affichage d'un client
